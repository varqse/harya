...
const cardData = [
    // { id: 1, title: 'Card 1', img: photo1, text: 'lorem ipsum', link: 'https://www.linkedin.com/in/harya-pranatreshna-a69781a/' },
        ...
        <Accordion.Item eventKey="2" className="item">
          ...
          <Accordion.Body>
            <div>
              ...
              <p>
              {/* Corporate Research and Development - Project Support responsible for maintaining assets and allocate resources through inovation and renovation activities in Product Development Lab, Pilot Plant, Packaging Development Lab, Sensory Lab, Product Application Lab, Market Monitoring Lab, Product Shelf Life Lab.
              Supports Product Development Team in order to have efficient and effective resource and comprehensive development activities in all laboratory units. */}
              </p>
            </div>
            <div className="mt-3">
